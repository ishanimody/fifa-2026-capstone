...
**📋 BEFORE YOU BEGIN:**
- **Contact Darsh** to receive your database credentials (username and password)
...
**Important:** The `backup.sql` file contains all the database structure and data (approximately 50-150 MB). Darsh will ensure this file is included in the repository or shared separately. If you don't see it after cloning, contact Darsh.
...
**IMPORTANT:** The database and user accounts have already been set up by the project lead. You will receive your credentials directly from Darsh.
...
**Before proceeding:**
1. Ensure you have received your database credentials from Darsh
...
```bash
# Double-check you're using the correct credentials provided by Darsh
...
```bash
# Contact Darsh - your user may need additional permissions
...
# IMPORTANT: Replace YOUR_USERNAME and YOUR_PASSWORD with credentials from Darsh
DATABASE_URL=postgresql://YOUR_USERNAME:YOUR_PASSWORD@localhost:5432/worldcup_intelligence

# Example if your username is "employee" and password is "emp2026":
# DATABASE_URL=postgresql://employee:emp2026@localhost:5432/worldcup_intelligence
...
2. **Create Server Connection:**
   ...
   - **Connection Tab:**
     ...
     - Username: `YOUR_USERNAME` (from Darsh)
     - Password: `YOUR_PASSWORD` (from Darsh)
...
### **DBeaver (Cross-Platform Alternative)**
...
2. **Import SQL File:**
   - Right-click database → "Tools" → "Execute SQL Script"
   - Select `backup.sql`
   - Click "Execute"
...
# - Contact Darsh to get the backup.sql file
...
# If you encounter this error, contact Darsh
...
# Contact Darsh if you need to do this - they have postgres superuser access
...
**Solution:**
```bash
# 1. Verify you're using the correct credentials from Darsh
...
# 4. If still failing, contact Darsh to verify your account is active
```
...
- [ ] Use a production WSGI server (gunicorn/waitress, not Flask dev server)
- [ ] Enable HTTPS/SSL certificates
- [ ] Set up proper database backups (daily automated)
...
- **Leaflet.js Guides:** https://leafletjs.com/examples.html
...
**Setup complete! You're ready to develop and analyze World Cup 2026 security intelligence data.**
